    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main className="container py-12 lg:py-16">
        <section className="section-shell mx-auto max-w-4xl space-y-5">
          ...
          <p className="text-muted-foreground">CineMatch currently uses your quiz selections and searches only to generate on-page recommendations. No account is required and no personal profile is stored in this version.</p>
